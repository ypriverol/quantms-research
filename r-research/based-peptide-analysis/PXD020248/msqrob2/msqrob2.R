...
## CM (center.median)
MQ_pep = read.csv("./PXD020248/peptides_filter.txt", sep = "\t")
...
L <- makeContrast("conditionDMSO=0", parameterNames = c("conditionDMSO"))
pe <- hypothesisTest(object = pe, i = "protein", contrast = L)


volcano <- ggplot(
  rowData(pe[["protein"]])$conditionDMSO,
...
write.csv(rowData(pe[["protein"]])$conditionDMSO, file = "PXD020248-maxquant-dep-CM.csv")
...
write.csv(rowData(pe[["protein"]])$conditionDMSO, file = "PXD020248-maxquant-dep-Q.csv")
...
write.csv(rowData(pe[["protein"]])$conditionDMSO, file = "PXD020248-maxquant-dep-NN.csv")
...
mzTab_pep = mzTab_pep[,c("sequence", "accession", "sumIntensity_1", "sumIntensity_2", "sumIntensity_3", "sumIntensity_4",
                         "sumIntensity_5", "sumIntensity_6", "sumIntensity_7", "sumIntensity_8",
                         "sumIntensity_9", "sumIntensity_10", "sumIntensity_11", "sumIntensity_12")]
...
write.csv(rowData(pe[["protein"]])$conditionDMSO, file = "PXD020248-quantms-dep-CM.csv")
...
write.csv(rowData(pe[["protein"]])$conditionDMSO, file = "PXD020248-quantms-dep-Q.csv")
...
write.csv(rowData(pe[["protein"]])$conditionDMSO, file = "PXD020248-quantms-dep-NN.csv")
