...
setwd('D:/dataset/R downstream analysis/0-paper/data_benchmark/0-reviewer/peptide based/PXD020248')
...
write.csv(DDA2009.comparisons$ComparisonResult, file="MSstats_output-quantms.csv")
...
write.csv(DDA2009.comparisons$ComparisonResult, file="MSstats_output-maxquant.csv")